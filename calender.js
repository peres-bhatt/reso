...
dA[x++] = "00000107 <h3>Sheela Emiliana Peris Bhatt (D'Souza)'s Birthday (1988) <br> Jonah Aloysius - Sheela Emiliana (D'Souza) Peres Bhatt's Wedding Anniversary (2016) <br>Doris Mary Peres Bhatt's Birthday (1891) <br><br>";
...
dA[x++] = "00000210 <h3>Jerome Augustine Peres Bhatt's Birthday (1943) <br> Allan - Tanya (D'Souza) Lobo's Wedding Anniversary";
...
dA[x++] = "00000217 <h3>Sr. Harriet (Irene) Peres Bhatt's Birthday <br><br>";
...
dA[x++] = "00000302 <h3>Gration D'Mello's Birthday<br> Harrold Peres Bhatt's Birthday <br><br>";
...
dA[x++] = "00000319 <h3>Allwyn Lobo's Birthday (1937) <br><br>";
...
dA[x++] = "00000401 <h3>Monica Emerciana (Suares) Peres Bhatt's Birthday <br><br>";
...
dA[x++] = "00000501 <h3>Gilbert Phillip Peres Bhatt's Birthday (1915) <br><br>";
...
dA[x++] = "00000511 <h3>Fabian (69) - Flavian (Lobo) Peres Bhatt's Wedding Anniversary (1981) <br><br>";
dA[x++] = "00000513 <h3>Deral Robbert D'Mello's Birthday <br><br>";
...
dA[x++] = "00000610 <h3>Merwin Pais's Birthday <br> Neville Rego's Death Anniversary (2010) <br><br>";
...
dA[x++] = "00000617 <h3>Anna Joanna Patrao's Birthday<br><br>";
dA[x++] = "00000619 <h3>Titus Antony Peres Bhatt's Birthday <br><br>";
dA[x++] = "00000621 <h3>Benny (Peres Bhatt) Lobo's Birthday (1913) <br><br>";
dA[x++] = "00000623 <h3>Delmon D'Mello's Birthday <br><br>";
dA[x++] = "00000625 <h3>Cosmos Peres Bhatt's Birthday <br>Francis Augustine Rego's Death Anniversary (1949) <br><br>";
...
dA[x++] = "00000708 <h3>Mehul Peres Bhatt's Birthday <br>Alphonso Joseph's Birthday <br><br>";
...
dA[x++] = "00000715 <h3>Henry Pinto's Birthday <br><br>";
dA[x++] = "00000723 <h3>Daniel Pinto's Birthday <br><br>";
dA[x++] = "00000725 <h3>Winifred Lorna Peres Bhatt's death Anniversary (1996) <br><br>";
dA[x++] = "00000728 <h3>Celine Rego's Death Anniversary (2009) <br>Alex Rodrigues's Birthday (1928) <br> Elsie Rose Teresa Noronha's Death Anniversary (2018) <br><br>";
dA[x++] = "00000729 <h3>Vernon Peres Bhatt's Birthday <br><br>";
dA[x++] = "00000806 <h3>Anita (Peres Bhatt) Barboza's Birthday <br><br>";
dA[x++] = "00000807 <h3>Lydia (Pinto) Lobo's Birthday (1941) <br><br>";
...
dA[x++] = "00000811 <h3>Celene Pinto's Birthday <br><br>";
...
dA[x++] = "00000911 <h3>Fabian (69) Peres Bhatt's Birthday (1952) <br><br>";
dA[x++] = "00000914 <h3>Merryl (67) - Grace (Soans) Menezes's Wedding Anniversary (1986) <br><br>";
...
dA[x++] = "00000930 <h3>Jerome Salvador Rego's Birthday (1900) <br><br>";
...
dA[x++] = "00001022 <h3>Francis Augustine Rego's Birthday (1891) <br>Elsie Rose Teresa Noronha's Birthday (1925) <br><br>";
dA[x++] = "00001025 <h3>Desmond Edward D'Mello's Birthday <br> Anna Joanna (Peres Bhatt) Patrao's Death Anniversary <br><br>";
dA[x++] = "00001027 <h3>Mercy Patrao's Birthday <br><br>";
dA[x++] = "00001028 <h3>Prakash - Gloria (Peres Bhatt) Serao's Wedding Anniversary <br><br>";
dA[x++] = "00001031 <h3>Harmon Roshan Victor Peres Bhatt's Birthday <br>Neville Rego's Birthday <br><br>";
...
dA[x++] = "00001124 <h3>Merryl (67) Menezes's Birthday  <br><br>";
...
dA[x++] = "00001211 <h3>Lily Marceline (Peres Bhatt) Pinto's Birthday <br> Jyothi Maria (D'Souza) D'Mello's Birthday <br><br>";
...
dA[x++] = "00001226 <h3>Nancy Rita (Peres Bhatt) D'Mello's Birthday  (1938) <br> Jacintha Pramila (Monterio) Peres Bhatt's Birthday <br> Arun William - Jyothsna Winifred (Peris Bhatt) D'Souza Wedding Anniversary (2008) <br><br>";
